<%-- 
    ...
    Created on : 17 Nov 2020, 14:42:05
    Author     : cilli
--%>
...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
     <a href="Informative.jsp">Any</a>
    <a href="Informative_Blue.jsp">Blue</a>
    <a href="Informative_Yellow.jsp">Yellow</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/H.png" style= "border: 9px solid #007bff;alt="></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Hospital</a>
                </h4>
                <h5><b>$6.00</b></h5>
                <ul class="card-text">
                    <li><b>Description:</b> Indicates Hospital ahead
                     </li>
                     <li><b>Colour:</b> Blue
                     </li> 
                     <li><b>Height:</b> .4m
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100"style=>
              <a href="#"><img class="card-img-top" src="Images/airport.png"style= "border: 9px solid #007bff; alt=""></a>
              <div class="card-body" >
                <h4 class="card-title">
                  <a href="#"> Airport</a>
                </h4>
                <h5><b>$5.00</b></h5>
            <ul class="card-text" >
                   <li><b>Description:</b> Indicates Airport ahead
                     </li>
              ...
              <div class="card-footer">
                ...
                <form action="cart" method="post"><% if (user != null){ %>
                <input type="hidden" name="productCode" value="8601">
                <input type="submit" id="Add to Cart" value="Add To Cart"style= "color: white !Important;background-color: #007bff !Important;"><% } %>
            </form><!--<a href="cart?productCode=8601">Add To Cart</a>-->
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/one way.png"style= "border: 9px solid #007bff; alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">One Way</a>
                </h4>
                <h5><b>$4.00</b></h5>
                <ul class="card-text">
                   <li><b>Description:</b> Indicates One Way ONLY
                     </li>
                      <li><b>Colour:</b> Blue
                     </li> 
                     <li><b>Height:</b> .2m
