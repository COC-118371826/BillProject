<%-- 
    Document   : Reg_Products
    Created on : 17 Nov 2020, 14:45:27
    Author     : cilli
--%>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="index.html"Style="color:white !important;">Home
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/No Entry.jpg"style= "border: 9px solid #007bff; alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">No Entry</a>
                </h4>
                <h5><b>$6.00</b></h5>
                <ul class="card-text">
                   <li><b>Description:</b> Indicates No Entry
                     </li>
                      <li><b>Colour:</b> Red
                     </li> <li><b>Height:</b> .32m
                     </li> <li><b>Weight:</b> 5Kg
                     </li>
                </ul>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/No Right.png"style= "border: 9px solid #007bff; alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#"> No Right Turn</a>
                </h4>
                  <h5><b>$2.00</b></h5>
            <ul class="card-text">
                   <li><b>Description:</b> Indicates No Right Turn
                     </li>
                      <li><b>Colour:</b> Red
                     </li> <li><b>Height:</b> .2m
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/No left.png"style= "border: 9px solid #007bff; alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">No Left Turn</a>
                </h4>
                <h5>$4.00</h5>
                <ul class="card-text">
                   <li><b>Description:</b> Indicates No Left Turn
                     </li>
                      <li><b>Colour:</b> Red
                     </li> <li><b>Height:</b> .12m
