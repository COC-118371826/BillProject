...
function filterFunction() {
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/leftturn.png" style= "border: 9px solid #007bff;alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Traffic merge</a>
                </h4>
                <h5><b>$5.00</b></h5>
                <ul class="card-text">
                                           <li><b>ID:</b> 10
 ...
 <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/roadwork.png" style= "border: 9px solid #007bff;alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Road Works</a>
                </h4>
